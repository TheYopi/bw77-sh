...
Scope {
    ...
    function currentList() {
        return scope.pendingList !== null ? scope.pendingList : scope.visibleList;
    }
    ...
    function dismiss(id) {
        scheduleList(currentList().filter(n => n.id !== id));
